...
FSimpleHttpManage* FSimpleHttpManage::Instance = nullptr;
...
bool FSimpleHttpManage::FHTTP::GetObjectToMemory(const FSimpleHTTPHandle& Handle,
                                                 const FString& URL)
{
	const TWeakPtr<FSimpleHttpActionRequest> Object = Find(Handle);
...
bool FSimpleHttpManage::FHTTP::GetObjectToMemory(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate,
                                                 const FString& URL)
{
	SIMPLE_HTTP_REGISTERED_REQUEST_BP(EHTTPRequestType::SINGLE);
	RegisteredHttpRequest
	return GetObjectToMemory(Handle, URL);
}

bool FSimpleHttpManage::FHTTP::GetObjectToMemory(const FSimpleHTTPResponseDelegate& BPResponseDelegate,
                                                 const FString& URL)
{
...
void FSimpleHttpManage::FHTTP::GetObjectsToMemory(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate,
                                                  const TArray<FString>& URL)
{
...
void FSimpleHttpManage::FHTTP::GetObjectsToMemory(const FSimpleHTTPResponseDelegate& BPResponseDelegate,
                                                  const TArray<FString>& URL)
{
...
bool FSimpleHttpManage::FHTTP::GetObjectToLocal(const FSimpleHTTPHandle& Handle, const FString& URL,
...
bool FSimpleHttpManage::FHTTP::GetObjectToLocal(const FSimpleHTTPResponseDelegate& BPResponseDelegate,
                                                const FString& URL, const FString& SavePaths)
{
	SIMPLE_HTTP_REGISTERED_REQUEST(EHTTPRequestType::SINGLE);
...
bool FSimpleHttpManage::FHTTP::GetObjectToLocal(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate,
                                                const FString& URL, const FString& SavePaths)
{
	SIMPLE_HTTP_REGISTERED_REQUEST_BP(EHTTPRequestType::SINGLE);
...
void FSimpleHttpManage::FHTTP::GetObjectsToLocal(const FSimpleHTTPHandle& Handle, const TArray<FString>& URL,
                                                 const FString& SavePaths)
{
	TWeakPtr<FSimpleHttpActionRequest> Object = Find(Handle);
	if (Object.IsValid())
...
void FSimpleHttpManage::FHTTP::GetObjectsToLocal(const FSimpleHTTPResponseDelegate& BPResponseDelegate,
                                                 const TArray<FString>& URL, const FString& SavePaths)
{
	SIMPLE_HTTP_REGISTERED_REQUEST(EHTTPRequestType::MULTPLE);
...
void FSimpleHttpManage::FHTTP::GetObjectsToLocal(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate,
                                                 const TArray<FString>& URL, const FString& SavePaths)
{
	SIMPLE_HTTP_REGISTERED_REQUEST_BP(EHTTPRequestType::MULTPLE);
...
bool FSimpleHttpManage::FHTTP::PutObjectFromBuffer(const FSimpleHTTPHandle& Handle, const FString& URL,
...
bool FSimpleHttpManage::FHTTP::PutObjectFromBuffer(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate,
                                                   const FString& URL, const TArray<uint8>& Buffer)
{
	SIMPLE_HTTP_REGISTERED_REQUEST_BP(EHTTPRequestType::SINGLE);
...
bool FSimpleHttpManage::FHTTP::PutObjectFromBuffer(const FSimpleHTTPResponseDelegate& BPResponseDelegate,
                                                   const FString& URL, const TArray<uint8>& Buffer)
{
	SIMPLE_HTTP_REGISTERED_REQUEST(EHTTPRequestType::SINGLE);
...
bool FSimpleHttpManage::FHTTP::PutObjectFromStream(const FSimpleHTTPHandle& Handle, const FString& URL,
...
bool FSimpleHttpManage::FHTTP::PutObjectFromStream(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate,
                                                   const FString& URL, TSharedRef<FArchive, ESPMode::ThreadSafe> Stream)
{
	SIMPLE_HTTP_REGISTERED_REQUEST_BP(EHTTPRequestType::SINGLE);
...
bool FSimpleHttpManage::FHTTP::PutObjectFromStream(const FSimpleHTTPResponseDelegate& BPResponseDelegate,
                                                   const FString& URL, TSharedRef<FArchive, ESPMode::ThreadSafe> Stream)
{
	SIMPLE_HTTP_REGISTERED_REQUEST(EHTTPRequestType::SINGLE);
...
bool FSimpleHttpManage::FHTTP::PutObjectFromLocal(const FSimpleHTTPHandle& Handle, const FString& URL,
...
bool FSimpleHttpManage::FHTTP::PutObjectFromLocal(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate,
                                                  const FString& URL, const FString& LocalPaths)
{
	SIMPLE_HTTP_REGISTERED_REQUEST_BP(EHTTPRequestType::SINGLE);
...
bool FSimpleHttpManage::FHTTP::PutObjectFromLocal(const FSimpleHTTPResponseDelegate& BPResponseDelegate,
                                                  const FString& URL, const FString& LocalPaths)
{
	SIMPLE_HTTP_REGISTERED_REQUEST(EHTTPRequestType::SINGLE);
...
bool FSimpleHttpManage::FHTTP::PutObjectsFromLocal(const FSimpleHTTPHandle& Handle, const FString& URL,
                                                   const FString& LocalPaths)
{
	return PutObjectFromLocal(Handle, URL, LocalPaths);
}

bool FSimpleHttpManage::FHTTP::PutObjectsFromLocal(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate,
                                                   const FString& URL, const FString& LocalPaths)
{
	SIMPLE_HTTP_REGISTERED_REQUEST_BP(EHTTPRequestType::MULTPLE);
...
bool FSimpleHttpManage::FHTTP::PutObjectsFromLocal(const FSimpleHTTPResponseDelegate& BPResponseDelegate,
                                                   const FString& URL, const FString& LocalPaths)
{
	SIMPLE_HTTP_REGISTERED_REQUEST(EHTTPRequestType::MULTPLE);
...
void FSimpleHttpManage::FHTTP::DeleteObjects(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate,
                                             const TArray<FString>& URL)
{
	SIMPLE_HTTP_REGISTERED_REQUEST_BP(EHTTPRequestType::MULTPLE);
...
void FSimpleHttpManage::FHTTP::DeleteObjects(const FSimpleHTTPResponseDelegate& BPResponseDelegate,
                                             const TArray<FString>& URL)
{
	SIMPLE_HTTP_REGISTERED_REQUEST(EHTTPRequestType::MULTPLE);
...
TArray<uint8>& USimpleHttpContent::GetContent() const
{
	return *Content;
}

bool USimpleHttpContent::Save(const FString& LocalPath) const
{
