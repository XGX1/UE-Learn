...
namespace SimpleHTTP
{
	namespace HTTP
	{
		struct FHTTPClient
		{
			...
			static bool GetObject(FGetObjectRequest &Request);
			static bool DeleteObject(FDeleteObjectsRequest &Request);
			static bool PutObject(FPutObjectRequest &Request);
			static bool PostObject(FPostObjectsRequest &Request);
			static void AbortRequest(IHTTPClientRequest &Request);
		};
	}
}