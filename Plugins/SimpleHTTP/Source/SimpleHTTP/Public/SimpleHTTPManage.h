...
class SIMPLEHTTP_API FSimpleHttpManage : public FTickableGameObject
{
	...
	struct SIMPLEHTTP_API FHTTP
	{
		 ...
		 */
		bool GetObjectToMemory(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate,
		                       const FString& URL);
		 ...
		 * @Return						Returns true if the request succeeds 
		 */
		bool GetObjectToLocal(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate, const FString& URL,
		 ...
		 * @param SavePaths				Path to local storage .
		 */
		void GetObjectsToLocal(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate, const TArray<FString>& URL,
		                       const FString& SavePaths);
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectFromLocal(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate, const FString& URL,
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectsFromLocal(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate, const FString& URL,
		                         const FString& LocalPaths);
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectFromBuffer(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate, const FString& URL,
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectFromStream(const FSimpleHTTPBPResponseDelegate& BPResponseDelegate, const FString& URL,
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool GetObjectToLocal(const FSimpleHTTPResponseDelegate& BPResponseDelegate, const FString& URL,
		                      const FString& SavePaths);
		 ...
		 * @param SavePaths				Path to local storage .
		 */
		void GetObjectsToLocal(const FSimpleHTTPResponseDelegate& BPResponseDelegate, const TArray<FString>& URL,
		                       const FString& SavePaths);
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectFromLocal(const FSimpleHTTPResponseDelegate& BPResponseDelegate,
		                        const FString& URL,
		                        const FString& LocalPaths);
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectsFromLocal(const FSimpleHTTPResponseDelegate& BPResponseDelegate,
		                         const FString& URL,
		                         const FString& LocalPaths);
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectFromBuffer(const FSimpleHTTPResponseDelegate& BPResponseDelegate,
		                         const FString& URL,
		                         const TArray<uint8>& Buffer);
		 ...
		 * @Return						Returns true if the request succeeds
		 */
		bool PutObjectFromStream(const FSimpleHTTPResponseDelegate& BPResponseDelegate,
		                         const FString& URL,
		                         TSharedRef<FArchive, ESPMode::ThreadSafe> Stream);
	...
	private:
		...
		FSimpleHTTPHandle RegisteredHttpRequest(EHTTPRequestType RequestType = EHTTPRequestType::SINGLE,
		                                        FSimpleHttpSingleRequestCompleteDelegate
		                                        SimpleHttpRequestCompleteDelegate =
			                                        FSimpleHttpSingleRequestCompleteDelegate(),
		                                        FSimpleHttpSingleRequestProgressDelegate
		                                        SimpleHttpRequestProgressDelegate =
			                                        FSimpleHttpSingleRequestProgressDelegate(),
		                                        FSimpleHttpSingleRequestHeaderReceivedDelegate
		                                        SimpleHttpRequestHeaderReceivedDelegate =
			                                        FSimpleHttpSingleRequestHeaderReceivedDelegate(),
		                                        FAllRequestCompleteDelegate AllRequestCompleteDelegate =
			                                        FAllRequestCompleteDelegate());
		 ...
		 */
		FSimpleHTTPHandle RegisteredHttpRequest(EHTTPRequestType RequestType = EHTTPRequestType::SINGLE,
		                                        FSimpleSingleCompleteDelegate SimpleHttpRequestCompleteDelegate =
			                                        nullptr,
		                                        FSimpleSingleRequestProgressDelegate SimpleHttpRequestProgressDelegate =
			                                        nullptr,
		                                        FSimpleSingleRequestHeaderReceivedDelegate
		                                        SimpleHttpRequestHeaderReceivedDelegate = nullptr,
		 ...
		 * @param Handle	Easy to find requests .
		 */
		bool PutObjectFromStream(const FSimpleHTTPHandle& Handle, const FString& URL,
		                         TSharedRef<FArchive, ESPMode::ThreadSafe> Stream);
	...
	private:
		...
		static TWeakPtr<FSimpleHttpActionRequest> Find(const FSimpleHTTPHandle& Handle);
